...
class CarrinhoController extends ActiveController
{
    ...
    public function actionGetativo($id)
    {
        $carrinhos = $this->modelClass::find()->where(['users_id' => $id, 'estado' => 'ativo'])->all();
        if ($carrinhos) {
            return $carrinhos;
        }
        else{
    ...
    public function actionGetfinalizado($id)
    {
        $carrinhos = $this->modelClass::find()->where(['users_id' => $id, 'estado' => 'finalizado'])->all();
        if ($carrinhos) {
            return $carrinhos;
        }
        else{
